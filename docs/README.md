...
> Two link conventions keep them working both on GitHub and under a future static site generator, which will
> publish `docs/` and nothing else:
>
> - **between documentation pages** — always **relative** (`./installation.md`), never absolute.
...
> `make check-doc-links` after moving or renaming anything here.
