...
- [2. HSM \& TPM guides](#2-hsm--tpm-guides)
- [3. Kubernetes integration guides](#3-kubernetes-integration-guides)
- [4. CLI reference](#4-cli-reference)
- [5. Helper tools \& scripts](#5-helper-tools--scripts)
- [6. Diagrams \& images](#6-diagrams--images)
...
| [How to initialize and simply test TPM in Linux](./How%20to%20initialize%20and%20simply%20test%20TPM%20in%20Linux_20220505.pdf) | Background material (PDF) |
