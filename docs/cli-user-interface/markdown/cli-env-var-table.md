...
| k8s-kms-plugin docs | --provenance |  | K8S_KMS_PLUGIN_DOCS_PROVENANCE | k8s-kms-plugin.docs.provenance | auto | bool | false | Stamp build and CI run provenance into the front matter of generated markdown. Defaults to true when GITHUB_ACTIONS=true. |
